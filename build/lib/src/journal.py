...
def create_ideal_trade(uid: str, entry_price: float, sl_price: float, tp_price: float, close_price: Optional[float] = None) -> Execution:
    trade = Execution(uid=uid, execution_type="ideal")
    position = TradePosition(entry_price=entry_price, sl_price=sl_price, tp_price=tp_price, close_price=close_price)
